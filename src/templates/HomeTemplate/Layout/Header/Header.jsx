...
export default function Header() {
  ...
  <div className="container flex justify-between h-16 mx-auto">
    ...
    <div className="items-center flex-shrink-0 hidden lg:flex">
      <button className="self-center px-5 py-2 rounded">Sign in</button>
      <button className="self-center px-5 py-2 font-semibold rounded bg-yellow-400 text-gray-900">Sign up</button>
    </div>
