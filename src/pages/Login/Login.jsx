...
import { loginAction } from '../../redux/actions/UserInfoAction';
...
export default function Login() {
  ...
  const formik = useFormik({
    ...
    onSubmit: values => {
      ...
      const userInfo = {taiKhoan: account, matKhau: password}
  ...
  return (
    ...
    <div className="py-12 bg-indigo-100 lg:bg-white flex justify-center lg:justify-start lg:px-12">
      <div className="cursor-pointer flex items-center">
        ...
        <div className="text-2xl text-indigo-800 tracking-wide ml-2 font-semibold">CGV cinema</div>
      </div>
    </div>
        ...
        <form onSubmit={(e)=>{ e.preventDefault();
          ...
          <div>
            ...
            <input  
                    ...
                    className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" placeholder="mike" />
          </div>
          <div className="mt-8">
